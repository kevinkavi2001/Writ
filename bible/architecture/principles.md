...
### Enforcement
PHPMD magic number detection, ruff, eslint no-magic-numbers (ENF-POST-007).
...
### Enforcement
- Python: ruff rule B904 (raise-without-from-inside-except) - PHP: see PHP-TRY-001 and PHP-ERR-001
